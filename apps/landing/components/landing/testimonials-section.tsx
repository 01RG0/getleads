...
const testimonials = [
  {
    quote: "LeadScale gave our reps a trusted starting point. Enrichment and verification now happen before a lead reaches the queue.",
    author: "Revenue operations lead",
    role: "Pilot team",
    company: "Meridian Labs",
    metric: "Cleaner lead handoffs",
  },
  {
    ...
    metric: "Faster rep follow-up",
  },
  {
    quote: "Finally, a resilience layer that keeps provider failures from becoming lost opportunities.",
    author: "Growth systems team",
    role: "Pilot team",
    company: "Beacon AI",
    metric: "Recoverable workflows",
  },
  {
    quote: "The integrations are seamless. We connected our entire stack in a single afternoon.",
    author: "Founding revenue team",
    role: "Pilot team",
    company: "Prism Analytics",
    metric: "Connected in one workflow",
  },
];
