      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-muted-foreground">
            ...
            Revenue infrastructure for high-intent teams
          </span>
        </div>
        ...
        <div className="flex gap-16 marquee whitespace-nowrap">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex gap-16">
              {[
                { value: "20 days", label: "saved on builds", company: "MERIDIAN LABS" },
                { value: "98%", label: "faster deployment", company: "FLUX SYSTEMS" },
                { value: "300%", label: "throughput increase", company: "BEACON AI" },
                { value: "6x", label: "faster to ship", company: "PRISM ANALYTICS" },
              ].map((stat) => (
